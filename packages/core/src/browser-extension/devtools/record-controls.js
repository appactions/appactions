...
export default function RecordControls() {
    ...
    const [justDidClear, setJustClear] = useTemporaryState(false);
    const [justDidSave, setJustDidSave] = useTemporaryState(false);

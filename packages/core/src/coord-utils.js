 ...
 */
export function getCypressElementCoordinates(jqueryEl, position, scrollBehavior) {
    ...
    const [posX, posY] = getPositionedCoordinates(x, y, width, height, position ?? 'center');
